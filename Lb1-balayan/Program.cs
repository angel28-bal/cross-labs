using Lb1_balayan.Data;  // Подключаем пространство имен, где находится ваш контекст данных
...
.AddJwtBearer(options =>
{
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        ValidIssuer = "BeautySalonAPI",
        ValidAudience = "BeautySalonAPI",
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "API для управления салоном красоты, включает CRUD операции для стилистов, клиентов и записей"
    });
